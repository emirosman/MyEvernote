...
namespace MyEvernote.Entities.ValueObjects
{
    public class LoginViewModel
    {
        ...
        [DisplayName("Kullanıcı Adı"), Required(ErrorMessage = "{0} alanı boş geçilemez"),DataType(DataType.Password), StringLength(25, ErrorMessage = "{0} maksimum {1} karakter olmalı")]
